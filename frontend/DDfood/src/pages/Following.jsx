          ...
          {user.following.map((following, index) => (
            ...
            >
              <Link
                ...
                className="card flex items-center gap-4 hover:border-accent-turquoise/50 transition-colors"
              >
                <img
                  src={following.avatar || '/images/default-avatar.svg'}
                ...
                <div>
                  ...
                  <p className="text-sm text-text-muted">@{following.username}</p>
                </div>
              </Link>
            </motion.div>
          ))}
